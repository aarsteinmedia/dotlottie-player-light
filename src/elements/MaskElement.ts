 ...
 *
 */
export default function MaskElement(
  this: {
    data: LottieLayer
    element: any
...
MaskElement.prototype.getMaskProperty = function (pos: number) {
  return this.viewData[pos].prop
}

MaskElement.prototype.renderFrame = function (isFirstFrame?: boolean) {
