 ...
 *
 */
export default function SVGShapeElement(
  this: any,
  data: LottieLayer,
...
SVGShapeElement.prototype.createGroupElement = function (data: Shape) {
...
SVGShapeElement.prototype.setElementStyles = function (elementData: any) {
