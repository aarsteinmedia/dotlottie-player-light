...
class SVGShapeElement {
  shapes: ShapeHandler[]
  shapesData: null | Shape[]
  stylesList: StyleObject[]
  shapeModifiers: any[]
  itemsData: null | ItemData[]
  ...
  */
  ...
  setElementStyles(elementData: ShapeDataInterface) {
...
interface SVGShapeElement extends BaseElement, TransformElement, SVGBaseElement,
  IShapeElement,
  HierarchyElement,
  FrameElement,
  RenderableDOMElement { }
