...
import type { LottieLayerData, Vector3 } from '@/types'
...
class TransformElement {
  finalTransform!: {
    ...
    localOpacity: number
    mat: Matrix
    mProp: LottieLayerData
  }

  mHelper = new Matrix()
  // Property for effect types
  private effectTypes = {
    TRANSFORM_EFFECT: 'transformEFfect', // TODO: Check if this is typo
  }
  private localTransforms?: any[]
  ...
  initTransform() {
    ...
    this.finalTransform = {
      ...
      mat,
      mProp: this.data.ks
        ? TransformProperty.getTransformProperty(this, this.data?.ks, this)
        : { o: 0 },
    }
    if (this.data.ao) {
...
interface TransformElement extends HierarchyElement {}
