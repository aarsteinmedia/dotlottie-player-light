...
TextProperty.prototype.setCurrentData = function (data: TextData) {
  if (!data.__complete) {
...
TextProperty.prototype.addEffect = function (effectFunction: unknown) {
  this.effectsSequence.push(effectFunction)
  this.elem.addDynamicProperty(this)
}

TextProperty.prototype.getValue = function (_finalValue: unknown) {
  if (
...
TextProperty.prototype.buildFinalText = function (text: string) {
...
TextProperty.prototype.completeTextData = function (
...
TextProperty.prototype.recalculate = function (index: number) {
...
TextProperty.prototype.canResizeFont = function (_canResize: boolean) {
  this.canResize = _canResize
  this.recalculate(this.keysIndex)
  this.elem.addDynamicProperty(this)
}

TextProperty.prototype.setMinimumFontSize = function (_fontValue: number) {
