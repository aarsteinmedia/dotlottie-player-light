...
export default class TransformProperty extends DynamicPropertyContainer {
  ...
  sk?: any // PropertyType
  v: Matrix
  private _addDynamicProperty =
    DynamicPropertyContainer.prototype.addDynamicProperty
  private defaultVector: Vector2
  ...
  static getTransformProperty(elem: any, data: any, container: any) {
  ...
  autoOrient() {
    //
    // const prevP = this.getValueAtTime();
  }
