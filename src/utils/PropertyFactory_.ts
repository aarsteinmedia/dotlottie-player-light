...
import DynamicPropertyContainer from './helpers/DynamicPropertyContainer'
...
class BaseProperty extends DynamicPropertyContainer {
  ...
  k?: boolean
  keyframes?: { t: number; h?: number; to?: number; o: { x: any } }[]
  keyframesMetadata?: { bezierData: any }[]
  kf?: boolean
  lock?: boolean
  mult?: number
...
export class KeyframedValueProperty extends BaseProperty {
  constructor(
    ...
    this._isFirstFrame = true
    this.getValue = this.processEffectsSequence
    this.effectsSequence = [this.getValueAtCurrentTime]
  }
}
