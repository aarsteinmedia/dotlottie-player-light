...
const ShapePropertyFactory = (function () {
  ...
  const EllShapeProperty = (function () {
     ...
     *
     */
    function EllShapePropertyFactory(this: any, elem: any, data: Shape) {
      this.v = shapePool.newElement()
  ...
  const StarShapeProperty = (function () {
     ...
     *
     */
    function StarShapePropertyFactory(this: any, elem: any, data: any) {
      this.v = shapePool.newElement()
  ...
  const RectShapeProperty = (function () {
     ...
     *
     */
    function RectShapePropertyFactory(this: any, elem: any, data: Shape) {
      this.v = shapePool.newElement()
      this.v.c = true
      this.localShapeCollection = shapeCollectionPool.newShapeCollection()
      this.localShapeCollection.addShape(this.v)
   ...
   *
   */
  function getShapeProp(elem: any, data: any, type: number, _?: unknown) {
    let prop
    if (type === 3 || type === 4) {
      ...
      prop = new (RectShapeProperty as any)(elem, data)
    } else if (type === 6) {
      prop = new (EllShapeProperty as any)(elem, data)
    } else if (type === 7) {
      prop = new (StarShapeProperty as any)(elem, data)
    }
    if (prop.k) {
